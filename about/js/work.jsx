        ...
        return (<div className={ this.state.wrap } >
                ...
                <h1>PORTFOLIO <i className="close" onClick={this.hide.bind(this)} >X</i></h1>
                    <ul className="portfolio">
                        <a href="/project/mcp"><li className="icon-component">
                            <h1>Mcom</h1><p>A jQuery component</p>
                        </li></a>
                        <a href="https://github.com/MaelWeb/Mvalidate" target="_blank"><li className="icon-validate">
                            <h1>Mvalidate</h1><p>form validate</p>
                        </li></a>
                        <a href="https://github.com/MaelWeb/Mcalenders" target="_blank"><li className="icon-calender">
